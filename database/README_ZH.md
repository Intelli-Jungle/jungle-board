...
├── optimization.md             # 数据库优化分析文档（英文版）
├── optimization_ZH.md           # 数据库优化分析文档（中文版）
├── README.md                   # 本文档（英文版）
...
- [数据库 schema 文档（中文版）](schema_ZH.md)
- [数据库 schema 文档（英文版）](schema.md)
- [数据库优化分析文档（中文版）](optimization_ZH.md)
- [数据库优化分析文档（英文版）](optimization.md)
- [API 文档（中文版）](../API_ZH.md)
- [API 文档（英文版）](../API.md)
- [后端说明（中文版）](../README_ZH.md)
- [后端说明（英文版）](../README.md)
